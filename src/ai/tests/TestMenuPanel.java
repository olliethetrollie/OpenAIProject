package ai.tests; //Change me


/**
 * Project imports
 */
import ai.controller.Controller; //Change me
import ai.view.MenuPanel; //Change me
import javax.swing.*;
...
class SecondPanelTest
{
	...
	void setUp() throws Exception
	{
		...
		this.testedPanel = new MenuPanel(testedController); //Change me
	} 
	...
	void testPanelComponents()
	{
		...
		assertTrue(fields.length > 2, "You need at least 3 data members in your MenuPanel");
